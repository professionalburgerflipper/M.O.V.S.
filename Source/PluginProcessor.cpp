...
//==============================================================================
MOVSAudioProcessor::MOVSAudioProcessor()
...
//==============================================================================
const juce::String MOVSAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool MOVSAudioProcessor::acceptsMidi() const
{
...
bool MOVSAudioProcessor::producesMidi() const
{
...
bool MOVSAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double MOVSAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int MOVSAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int MOVSAudioProcessor::getCurrentProgram()
{
    return 0;
}

void MOVSAudioProcessor::setCurrentProgram (int index)
{
}

const juce::String MOVSAudioProcessor::getProgramName (int index)
{
    return {};
}

void MOVSAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}

//==============================================================================
void MOVSAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void MOVSAudioProcessor::releaseResources()
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool MOVSAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void MOVSAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
//==============================================================================
bool MOVSAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* MOVSAudioProcessor::createEditor()
{
    return new MOVSAudioProcessorEditor (*this);
}

//==============================================================================
void MOVSAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void MOVSAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new MOVSAudioProcessor();
}

juce::AudioProcessorValueTreeState::ParameterLayout MOVSAudioProcessor::createParams()
{
...
void MOVSAudioProcessor::setParams()
{
    setVoiceParams();
    setFilterParams();
    setReverbParams();
...
void MOVSAudioProcessor::setVoiceParams()
{
    for (int i = 0; i < synth.getNumVoices(); ++i)
    {
        if (auto voice = dynamic_cast<SynthVoice*>(synth.getVoice(i)))
...
void MOVSAudioProcessor::setFilterParams()
{
...
void MOVSAudioProcessor::setReverbParams()
{
